    ...
    <div className="container">
      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          ...
          <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>&nbsp;Sign up</a>
            ...
            {item.value.split("\n").map((line, lineIndex) => (
              <motion.div
                ...
                variants={{
                  ...
                  visible: { y: 0, scale: 1, opacity: 1, transition: { duration: 0.2 }, ease: "easeIn" }
                }}
              >
                {line}
              </motion.div>
