...
const ExecutionControls = ({
  ...
  return (
    <motion.div 
      className="flex justify-between items-center gap-3 p-3 rounded-xl bg-slate-900/80 backdrop-blur-lg shadow-[0_0_30px_rgba(0,0,0,0.4)] border border-slate-800/50 w-full"
    ...
    >
      ...
      <motion.button
        ...
        data-tooltip={isRunning ? 'Pause execution' : 'Run code'}
      >
        {isRunning ? (
          <motion.div 
            className="flex items-center justify-center w-4 h-4" 
